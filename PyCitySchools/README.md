...
## Few findings from this exercise are
1. As the school size increase with number of students, students grades were affected. When school size was less than 1000 students the overall passing percentage was 89% but with school size between 2000-5000 the passing overall went down to 58%
2. The "per student budget" did not have much effect on overall student performance. The budget was analyzed from $585-$680 
3. The charter schools performed better than district schools. 
